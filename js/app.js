(() => {
    ...
    (() => {
        ...
        const initCursor = () => {
            ...
            const linkItemsDark = document.querySelectorAll(".dark");
            linkItemsDark.forEach((item => {
                item.addEventListener("mouseenter", (() => {
                    innerCursor.classList.add("animate-dark");
                }));
                item.addEventListener("mouseleave", (() => {
                    innerCursor.classList.remove("animate-dark");
                }));
            }));
            const linkItemsLigth = document.querySelectorAll("a");
            linkItemsLigth.forEach((item => {
                item.addEventListener("mouseenter", (() => {
                    innerCursor.classList.add("animate-ligth");
                }));
                item.addEventListener("mouseleave", (() => {
                    innerCursor.classList.remove("animate-ligth");
                }));
            }));
            const render = () => {
